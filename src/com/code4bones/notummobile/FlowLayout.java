...
public class FlowLayout extends ViewGroup {
    ...
    private void readStyleParameters(Context context, AttributeSet attributeSet) {
        ...
        try {
            horizontalSpacing = 2;//a.getDimensionPixelSize(R.styleable.FlowLayout_horizontalSpacing, 0);
            verticalSpacing = 2;//a.getDimensionPixelSize(R.styleable.FlowLayout_verticalSpacing, 0);
            orientation = HORIZONTAL;// //a.getInteger(R.styleable.FlowLayout_orientation, HORIZONTAL);
            debugDraw = false;// a.getBoolean(R.styleable.FlowLayout_debugDraw, false);
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        private void readStyleParameters(Context context, AttributeSet attributeSet) {
            ...
            try {
                horizontalSpacing = 2;//a.getDimensionPixelSize(R.styleable.FlowLayout_LayoutParams_layout_horizontalSpacing, NO_SPACING);
                verticalSpacing = 2;//a.getDimensionPixelSize(R.styleable.FlowLayout_LayoutParams_layout_verticalSpacing, NO_SPACING);
                newLine = false;// a.getBoolean(R.styleable.FlowLayout_LayoutParams_layout_newLine, false);
            } finally {
              //  a.recycle();
            }
        }
